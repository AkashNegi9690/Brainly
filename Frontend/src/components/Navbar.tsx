...
export const Navbar = ({issideBarOpen,setIsSideBarOpen,isSmallScreen}:NavBarProps) => {
  if(!issideBarOpen){
    return <div className="fixed top-0 left-0 bg-black  text-white hover:translate-x-1 hover:translate-y-1 transition-all duration-500 rounded-md">
    <div onClick={() => {
    ...
    return <div className={`w-80 bg-gray-100  h-screen p-4 flex flex-col gap-4 border-r-2 border-gray-300 fixed left-0 top-0 ${issideBarOpen?"bg-white/70 backdrop-blur-md dark:bg-black" :"bg-white"} transition-all duration-500 rounded-md`}>
