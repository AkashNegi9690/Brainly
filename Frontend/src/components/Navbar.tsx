...
export const Navbar = ({issideBarOpen,setIsSideBarOpen,isSmallScreen}:NavBarProps) => {
  if(!issideBarOpen){
    ...
    return <div className={`w-80  h-screen p-4 flex flex-col gap-4 border-r-2 border-gray-200 fixed left-0 top-0 ${issideBarOpen?"bg-white/70 backdrop-blur-md dark:bg-black" :"bg-white"} transition-all duration-500 rounded-md`}>
