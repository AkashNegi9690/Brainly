...
export function Modal(props:Modalprops){
    ...
    async function addContent(){
        ...
        if(!link){alert("Link Required");return;}
    ...
    return <div className="fixed top-0 left-0 flex justify-center items-center bg-white/20 backdrop-blur-sm w-full h-screen z-50    ">
        ...
        <div className=""><input ref={titleref} className="border-2 border-gray-200 p-2 rounded-md dark:text-black " type="text" placeholder="title..." required/></div>
        <div><input ref={linkref} className="border-2 border-gray-200 p-2 rounded-md dark:text-black" type="text" placeholder="link..." required/></div>
